...
class Menubar:
    def __init__(self, parent):
        ...
        menubar.add_command(
            label='Settings', command=parent.open_settings_file)
        menubar.add_cascade(label='About', menu=about_dropdown)
        menubar.add_command(label='Hex Colors')
        menubar.add_command(label='Excel Mode')
    ...
    def release_notes(self):
        ...
        box_message = 'Version 0.1 - Rino - This is the first version of ExEditor'
        messagebox.showinfo(box_title, box_message)
...
class Statusbar:
    def __init__(self, parent):
        ...
        self.status.set('ExEditor - v0.1 Rino')
